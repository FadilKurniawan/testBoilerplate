package com.devfk.ma.helper.socialauth.google
    ...
    fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                mListener?.onGoogleAuthSignIn(parseToGoogleUser(account!!).idToken, parseToGoogleUser(account).name)
                //asyncGoogle(account)
            } catch (e: ApiException) {
//                println("*** error ${e.statusCode} + ${e.message} + ${e.cause}")
